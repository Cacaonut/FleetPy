...
if __name__ == "__main__":
    ...
    print("Running minimal Manhattan Realtime V2 Ride-Pooling scenario (Decoupled Fleet Simulation & Fleet Control)...")
    run_scenarios(
        constant_config,
        scenario_config,
        log_level="info",
    ...
    print("\nRealtime V2 simulation complete! Results saved in studies/minimal_manhattan_realtime_v2/results/")
