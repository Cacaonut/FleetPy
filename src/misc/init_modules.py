...
def get_src_fleet_control_modules():
    ...
    op_dict["AsyncRidePoolingBatchOptimizationFleetControl"] = ("src.fleetctrl.AsyncRidePoolingBatchOptimizationFleetControl", "AsyncRidePoolingBatchOptimizationFleetControl")
    # add development content
    if dev_content is not None:
